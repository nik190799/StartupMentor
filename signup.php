...
<head>
    <title><? echo lang('create_new_account'); ?> | mentor-portal</title>
    <meta charset="UTF-8">
    <meta name="description" content="mentor-portal is a social network platform helps you meet new friends and stay connected with your family and with who you are interested anytime anywhere.">
    <meta name="keywords" content="signup,social network,social media,mentor-portal,meet,free platform">
    ...
    <div class="login_signup_navbar">
        <a href="index" class="login_signup_navbarLinks">mentor</a>
    ...
    <div align="center">
        ...
        <!--============[ sign up sec ]============-->
            ...
            <p><input type="email" name="signup_email" class="login_signup_textfield" id="em" placeholder="<? echo lang('email'); ?>"/></p>
             <p>
            <select class="login_signup_textfield" name="role" id="rl">
              <option selected><? echo lang('student'); ?>student</option>
              <option><? echo lang('mentor'); ?>mentor</option>
            </select>
            </p> 
