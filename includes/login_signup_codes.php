...
$signup_roleVar = filter_var(htmlentities($_POST['rl']),FILTER_SANITIZE_STRING);

if ($signup_roleVar == lang('student')) {
    $signup_role = "student";
}elseif ($signup_roleVar == lang('mentor')) {
    $signup_role = "mentor";
}else{
    $signup_role="student";
}
...
if($signup_fullname == null || $signup_username == null || $signup_email == null || $signup_password == null || $signup_cpassword == null){
    ...
    $signup_admin = "1";   
    $signupsql = "INSERT INTO signup (id,Fullname,Username,Email,Password,Userphoto,role,gender,language,admin)
    VALUES( :signup_id, :signup_fullname, :signup_username, :signup_email, :signup_password, :userphoto,:signup_role, :signup_gender,:signup_language,:signup_admin)";
    ...
    $query->bindParam(':signup_role', $signup_role, PDO::PARAM_STR);
    ...
    $signupsql = "INSERT INTO signup (id,Fullname,Username,Email,Password,Userphoto,role,gender,language)
    VALUES( :signup_id, :signup_fullname, :signup_username, :signup_email, :signup_password, :userphoto, :signup_role, :signup_gender,:signup_language)";
    $query = $conn->prepare($signupsql);
    $query->bindParam(':signup_id', $signup_id, PDO::PARAM_INT);
    $query->bindParam(':signup_fullname', $signup_fullname, PDO::PARAM_STR);
    $query->bindParam(':signup_username', $signup_username, PDO::PARAM_STR);
