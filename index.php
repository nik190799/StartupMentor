...
<head>
    <title><? echo lang('welcome'); ?> | Mentor-Portal</title>
    <meta charset="UTF-8">
    <meta name="description" content="Mentor-portal is a social network platform helps you meet new mentors and stay connected with them, regarding projects,technologies,doubts,etc and anytiime anywhere.">
    <meta name="keywords" content="homepage,main,login,social network,social media,mentor-portal,meet,free platform">
    <meta name="author" content="Ajinkya Khade">
    ...
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index" class="login_signup_navbarLinks">Mentor-portal</a>
        ...
        <h3 align="center"><? echo lang('welcome_to'); ?> mentor-portal</h3>
